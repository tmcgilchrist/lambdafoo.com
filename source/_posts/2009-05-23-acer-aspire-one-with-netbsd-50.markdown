...
meta: 
  _edit_last: "1"
  _aioseop_title: NetBSD 5.0 dmesg for Aspire One
  _aioseop_description: dmesg from NetBSD 5.0 for an Acer AspireOne 110L
  _aioseop_keywords: netbsd, netbsd 5, dmesg, aspireone, aao
---
...
wsdisplay0: screen 4 added (80x25, vt100 emulation)</pre>
<div><span>
</span></div>
<div><span>I'm writing up some notes on how the install went and special things I needed to do to get hardware working which I'll be posting sometime over the weekend.</span></div>
